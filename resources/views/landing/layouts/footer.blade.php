                                ...
                                <div class="footer-info-list footer-info-two">
                                    <ul class="list-wrap">
                                        <li>
                                            ...
                                            <div class="content">
                                                <a href="tel:081330109847">081330109847</a>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="footer-info-list footer-info-two">
                                    <ul class="list-wrap">
                                        <li>
                                            ...
                                            <div class="content">
                                                <a href="mailto:info@apexa.com">admin@akuratcenter.com</a>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
