        ...
        <div class="card mb-5 mb-xl-8 border-2 shadow p-3 mb-5 bg-white rounded">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        <a type="button" class="btn btn-sm btn-primary" href="{{ route('admin.mitra.create') }}">Tambah</a>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="text-muted mb-3">
                    Pada halaman ini digunakan untuk menambah, mengedit, dan detail mitra
                </div>
                    ...
                    <div class="d-flex flex-stack">
                        <div>
                            ...
                            <div class="fs-12 text-gray-700">
                                <div style="color: #d80000; font-weight: 500;">Data mitra adalah blok</div>
                                <div style="color: #008c46 ; font-weight: 500;">Data mitra adalah aktif</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="table-responsive">
                    <table id="example"
                        ...
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0 ">
                            ...
                            <th class="min-w-150px">Mitra</th>
                            <th class="min-w-150px">Kabupaten</th>
...
@section('javascript')
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#example').DataTable({
                ...
                buttons: [{
                    ...
                    collectionTitle: 'Column mitrability control',
                ...
                columns: [{
                ...
                },
                    {
                        data: "action",
                        render: function (data) {
                            var detail = '{{ route('admin.mitra.show', [':mitra']) }}';
                            var edit = '{{ route('admin.mitra.edit', [':mitra']) }}';
                            var x_edit = "";
                            var x_detail = "";
                            x_detail = `<a data-toggle='tooltip' data-placement='top' title='View' href='${detail.replace(':mitra', data)}' class='btn btn-icon btn-bg-light btn-active-text-primary btn-sm me-1'><span class='bi bi-file-text ' aria-hidden='true'></span></a>`;
                            x_edit = `<a data-toggle='tooltip' data-placement='top' title='Edit' href='${edit.replace(':mitra', data)}' class='btn btn-icon btn-bg-light btn-active-text-primary btn-sm me-1'><span class='bi bi-pencil ' aria-hidden='true'></span> </a>`;
        ...
        function deleteConfirmation(mitra) {
            Swal.fire({
                ...
                if (result.value) {
                    var destroy = '{{ route('admin.mitra.destroy', [':mitra']) }}';
                    $.ajax({
                        url: destroy.replace(':mitra', mitra),
                        method: 'DELETE',
                        data: {
                            "mitra": mitra,
                            "_token": "{{ csrf_token() }}"
