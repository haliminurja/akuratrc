...
@section('content')
    <div class="flex-column-fluid">
        <div class="card mb-5 mb-xl-8 border-2 shadow p-3 mb-5 bg-white rounded">
            ...
            <form action="{{ route('admin.sejarah.update', $id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <textarea type="text" name="deskripsi_sejarah" class="form-control form-control-sm " required>{{ $one?->deskripsi_sejarah }}</textarea>
