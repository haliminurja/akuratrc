            ...
            <form action="{{ route('admin.sejarah.store') }}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <textarea type="text" name="deskripsi_sejarah" class="form-control form-control-sm " required></textarea>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input type="number" name="tahun" class="form-control form-control-sm " required />
                    </div>
