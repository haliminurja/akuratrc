            ...
            <form action="{{ route('admin.header.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input type="text" name="pesan" class="form-control form-control-sm " required />
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2 required">
                            <span>Deskripsi</span>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input type="file" accept=".png, .jpg, .jpeg" id="foto" name="foto" class="form-control form-control-sm "  onchange="previewFoto()" required />
