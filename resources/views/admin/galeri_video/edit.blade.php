...
@section('content')
    <div class="flex-column-fluid">
        <div class="card mb-5 mb-xl-8 border-2 shadow p-3 mb-5 bg-white rounded">
            ...
            <form action="{{ route('admin.galeri_video.update', $id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input type="text" name="judul" class="form-control form-control-sm " value="{{$one?->judul}}" required />
                    </div>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input type="text" name="link" class="form-control form-control-sm " value="{{$one?->link}}" required />
                    </div>
