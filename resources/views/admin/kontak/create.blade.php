            ...
            <form action="{{ route('admin.kontak.store') }}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <textarea type="text" name="alamat" class="form-control form-control-sm " required></textarea>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input type="text" name="maps" class="form-control form-control-sm " required />
                    </div>
