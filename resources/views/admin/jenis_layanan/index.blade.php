        ...
        <div class="card mb-5 mb-xl-8 border-2 shadow p-3 mb-5 bg-white rounded">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        <a type="button" class="btn btn-sm btn-primary" href="{{ route('admin.jenis_layanan.create') }}">Tambah</a>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="text-muted mb-3">
                    Pada halaman ini digunakan untuk menambah, mengedit, dan detail jenis layanan
                </div>
                    ...
                    <div class="d-flex flex-stack">
                        <div>
                            ...
                            <div class="fs-12 text-gray-700">
                                <div style="color: #d80000; font-weight: 500;">Data jenis layanan adalah blok</div>
...
@section('javascript')
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#example').DataTable({
                ...
                buttons: [{
                    ...
                    collectionTitle: 'Column jenis_layananbility control',
                ...
                columns: [{
                ...
                },
                    {
                        data: "action",
                        render: function (data) {
                            var detail = '{{ route('admin.jenis_layanan.show', [':jenis_layanan']) }}';
                            var edit = '{{ route('admin.jenis_layanan.edit', [':jenis_layanan']) }}';
                            var x_edit = "";
                            var x_detail = "";
                            x_detail = `<a data-toggle='tooltip' data-placement='top' title='View' href='${detail.replace(':jenis_layanan', data)}' class='btn btn-icon btn-bg-light btn-active-text-primary btn-sm me-1'><span class='bi bi-file-text ' aria-hidden='true'></span></a>`;
                            x_edit = `<a data-toggle='tooltip' data-placement='top' title='Edit' href='${edit.replace(':jenis_layanan', data)}' class='btn btn-icon btn-bg-light btn-active-text-primary btn-sm me-1'><span class='bi bi-pencil ' aria-hidden='true'></span> </a>`;
        ...
        function deleteConfirmation(jenis_layanan) {
            Swal.fire({
                ...
                if (result.value) {
                    var destroy = '{{ route('admin.jenis_layanan.destroy', [':jenis_layanan']) }}';
                    $.ajax({
                        url: destroy.replace(':jenis_layanan', jenis_layanan),
                        method: 'DELETE',
                        data: {
